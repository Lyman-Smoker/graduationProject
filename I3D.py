...
class I3D(torch.nn.Module):
    ...
    def forward(self, inp):
        ...
        # for this experiment I add the view operation
...
if __name__ == '__main__':
    i3d = I3D(num_classes=400, modality='rgb', dropout_prob=0.5)
    i3d.load_state_dict(torch.load('/hdd/1/liyuanming/ComputerVision/pretrained_models/model_rgb.pth'))
    # input = torch.randn((128, 3, 16, 224, 224))
    # out = i3d(input)
    # print(out.size())
    # print(out.view(-1, 1024).shape)
    # total = sum([param.nelement() for param in i3d.parameters()])
